...
// * **Prefix (e.g., ++x):** The variable is incremented/decremented **first**, then the new value is used.
...
// * **Postfix (e.g., x++):** The current value of the variable is used **first**, then the variable is incremented/decremented.
...
/// Comparison operators - returnd true or false
